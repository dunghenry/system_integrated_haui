...
namespace TranVanDung_2019603537
{
    public partial class Form1 : Form
    {
        ...
        private void ThemNV_Click(object sender, EventArgs e)
        {
            ...
            string link = "https://localhost:44312/api/nhanvien/" + postNhanVien;
        ...
        {
            string link = "https://localhost:44312/api/nhanvien";
        ...
        private void XoaNV_Click(object sender, EventArgs e)
        {
            ...
            string link = "https://localhost:44312/api/nhanvien/" + deleteNhanVien;
            HttpWebRequest request = HttpWebRequest.CreateHttp(link);
        ...
        private void SuaNV_Click(object sender, EventArgs e)
        {
            ...
            string link = "https://localhost:44312/api/nhanvien/" + puttNhanVien;
            HttpWebRequest request = HttpWebRequest.CreateHttp(link);
            request.Method = "PUT";
            request.ContentType = "application/json;charset=UTF-8";
